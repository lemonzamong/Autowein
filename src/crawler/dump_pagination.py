...
# Correct pagination URL
TARGET_URL = "https://autowein.com/post-list2/?type=news&awp=1&tv=1"
...
def main():
    ...
    with open("debug_pagination.html", "w") as f:
        f.write(html)
    print("Saved to debug_pagination.html")
